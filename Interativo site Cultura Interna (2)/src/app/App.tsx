...
import {
  ...
  MessageCircle, Send, Briefcase, ExternalLink
} from "lucide-react";
...
const testeDISC = [
  { pergunta: "Tende a agir de forma...", opcoes: ["Assertiva", "Persuasiva", "Paciente", "Contemplativa"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Quando em conflito, esse estilo…", opcoes: ["Demanda ação", "Ataca", "Reclama", "Evita"], perfis: ["D", "I", "C", "S"] },
  { pergunta: "Necessita de...", opcoes: ["Controle", "Aprovação", "Rotina", "Padrão"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Abordagem primária...", opcoes: ["Independente", "Interativo", "Estável", "Corretivo"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Com atrasos...", opcoes: ["Se irrita e confronta", "Nem liga, está distraído", "Sabe do atraso, mas aceita", "Reclama e analisa a situação"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Confortável com...", opcoes: ["Ser decisivo", "Amizade social", "Ser parte de um time", "Planejamento e ordem"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Força aparente...", opcoes: ["Solucionador de problemas", "Encorajador", "Supporter", "Organizador"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Limitação desse perfil...", opcoes: ["Direto", "Desorganizado", "Indireto", "Detalhista"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Outra limitação desse perfil...", opcoes: ["Intenso", "Não tradicional", "Indeciso", "Impessoal"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Em situações extremas...", opcoes: ["Se preocupa demais com metas", "Fala sem pensar", "Procrastina ao invés de fazer", "Analisa demais"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Desejo de...", opcoes: ["Variedade", "Menos estrutura", "Harmonia", "Lógica"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Com erros...", opcoes: ["Informa o erro diretamente", "Chama a pessoa e explica o erro", "Fica calado e aceita o erro", "Se incomoda e questiona"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Possui medo de...", opcoes: ["Perder", "Rejeição", "Mudanças bruscas", "Estar errado"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Ponto cego...", opcoes: ["Ser responsabilizado", "Realizar compromissos", "Necessidade de mudança", "Tomada de decisão"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Precisa melhorar...", opcoes: ["Empatia e Paciência", "Controle emocional", "Ser assertivo sob pressão", "Se preocupar menos sobre tudo"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Sob estresse pode se tornar...", opcoes: ["Ditatorial", "Sarcástico", "Submisso", "Arredio"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Sob estresse pode se tornar...", opcoes: ["Crítico", "Superficial", "Indeciso", "Cabeça dura"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Mensura desempenho com...", opcoes: ["Resultados", "Reconhecimento", "Compatibilidade", "Precisão"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Mensura desempenho com...", opcoes: ["Histórico", "Elogios", "Contribuição", "Qualidade dos resultados"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Em uma discussão...", opcoes: ["Busca ter a razão", "Busca diminuir o conflito", "Busca concordância", "Busca comprovar sua opinião"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Característica principal...", opcoes: ["Franco", "Otimista", "Serviçal", "Ordeiro"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Pode ser considerado...", opcoes: ["Impaciente", "Inoportuno", "Indeciso", "Inseguro"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Com subalternos, costuma ser...", opcoes: ["Orgulhoso", "Permissivo", "Humilde", "Cauteloso"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Prefere tarefas...", opcoes: ["Desafiadoras", "Relacionada a pessoas", "Agendadas", "Estruturadas"], perfis: ["D", "I", "S", "C"] },
  { pergunta: "Quando vai às compras...", opcoes: ["Sabe o que quer", "Se diverte", "Fica indeciso", "Busca ofertas"], perfis: ["D", "I", "S", "C"] },
];
...
export default function App() {
  ...
  const [testePage, setTestePage] = useState<"menu" | "disc">("menu");
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 24px" }}>
        ...
        {tab === "Home" && (
          <div className="fade-in">
            ...
            {/* Missão */}
            <div className="fade-in" style={{ marginBottom: 32, animationDelay: "0.7s", opacity: 0, background: "#0D1117", border: "1px solid #1C2230", borderRadius: 12, padding: 28 }}>
        ...
        {tab === "Testes" && (
          <div className="fade-in" style={{ padding: "48px 0" }}>
            {testePage === "menu" && (
              <>
                <div className="section-label">Descubra seu perfil</div>
                <h2 className="big-title" style={{ color: "#fff", marginBottom: 40 }}>Teste DISC e <span style={{ color: "#1440FF" }}>Oportunidades</span></h2>

                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 24 }}>
                  {/* Trabalhe Conosco */}
                  <div className="tribo-card" style={{ cursor: "pointer" }} onClick={() => window.open("https://vagas.autoforce.com/", "_blank")}>
                    <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                      <div style={{ width: 48, height: 48, borderRadius: 10, background: "#1440FF18", display: "flex", alignItems: "center", justifyContent: "center" }}>
                        <Briefcase size={24} color="#1440FF" />
                      </div>
                      <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: 24, color: "#fff" }}>Trabalhe Conosco</div>
                    </div>
                    <p style={{ fontSize: 15, color: "#C9D1D9", lineHeight: 1.7, marginBottom: 16 }}>Quer fazer parte do nosso time de Racers? Confira nossas vagas abertas e venha acelerar com a gente!</p>
                    <div style={{ display: "flex", alignItems: "center", gap: 8, color: "#1440FF", fontSize: 14, fontWeight: 600 }}>
                      Ver Vagas <ExternalLink size={16} />
                    </div>
                  </div>
            ...
            {testePage === "disc" && !showResultadoDISC && (
              <>
                ...
                <h2 className="big-title" style={{ color: "#fff", marginBottom: 16 }}>Teste <span style={{ color: "#1440FF" }}>DISC</span></h2>
                <div style={{ background: "#1440FF11", border: "1px solid #1440FF44", borderRadius: 12, padding: "20px 24px", marginBottom: 32 }}>
                  <p style={{ fontSize: 15, color: "#C9D1D9", marginBottom: 12, lineHeight: 1.7 }}>
                    <strong style={{ color: "#1440FF" }}>📋 Instruções:</strong> Enumere as alternativas de <strong style={{ color: "#1440FF" }}>1 a 4</strong> para cada pergunta:
                  </p>
                  <div style={{ display: "flex", gap: 16, flexWrap: "wrap", marginTop: 16 }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      <div style={{ width: 32, height: 32, borderRadius: 6, background: "#1440FF", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700 }}>4</div>
                      <span style={{ fontSize: 14, color: "#C9D1D9" }}>MAIS se identifica</span>
                    </div>
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      <div style={{ width: 32, height: 32, borderRadius: 6, background: "#0D1117", border: "1px solid #1C2230", color: "#9CA3AF", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 700 }}>1</div>
                      <span style={{ fontSize: 14, color: "#C9D1D9" }}>MENOS se identifica</span>
                    </div>
                  </div>
                </div>

                {testeDISC.map((q, i) => {
                  const rankings = respostasDISC[i] || [0, 0, 0, 0];
                  const isComplete = rankings.every(r => r > 0) && rankings.filter(r => r > 0).length === 4;
                  const usedNumbers = rankings.filter(r => r > 0);
                  ...
                  return (
                    <div key={i} style={{ background: "#0D1117", border: "1px solid #1C2230", borderRadius: 12, padding: "24px", marginBottom: 16 }}>
                      ...
                      {hasDuplicates && <div style={{ fontSize: 13, color: "#FF4444", marginBottom: 12 }}>⚠️ Cada número (1, 2, 3, 4) deve ser usado apenas uma vez</div>}
                      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                        {q.opcoes.map((opc, j) => (
                          <div key={j} style={{ display: "flex", gap: 12, alignItems: "center", background: "#161B22", border: "1px solid #1C2230", borderRadius: 8, padding: "12px 16px" }}>
                              ...
                              {[1, 2, 3, 4].map(num => (
                                <button
                                  ...
                                  style={{
                                    ...
                                    height: 32,
                                    borderRadius: 6,
                                    border: rankings[j] === num ? "2px solid #1440FF" : "1px solid #1C2230",
                                    background: rankings[j] === num ? "#1440FF" : "#0D1117",
                                    color: rankings[j] === num ? "#fff" : "#9CA3AF",
                                    fontSize: 14,
                                    fontWeight: 700,
                                    cursor: "pointer",
                                  ...
                                  onMouseEnter={e => {
                                    if (rankings[j] !== num) {
                                      ...
                                      e.currentTarget.style.background = "#1440FF11";
                                    }
                                  }}
                                  onMouseLeave={e => {
                                    if (rankings[j] !== num) {
                            ...
                            <div style={{ flex: 1, fontSize: 14, color: "#C9D1D9" }}>{opc}</div>
                          </div>
                        ))}
                      </div>
                    </div>
                ...
                {respostasDISC.length === testeDISC.length && respostasDISC.every(r => r && r.every(n => n > 0) && r.filter(n => n > 0).length === 4) && (
            ...
            {testePage === "disc" && showResultadoDISC && (
              <>
                ...
                {(() => {
                  ...
                  respostasDISC.forEach((rankings, i) => {
                    rankings.forEach((rank, j) => {
                      const perfil = testeDISC[i].perfis[j];
                      contagem[perfil as keyof typeof contagem] += rank;
                    });
                  });
